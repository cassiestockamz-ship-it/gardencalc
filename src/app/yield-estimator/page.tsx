    ...
    >
      ...
      <div className="mt-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <a
            href={`https://www.amazon.com/s?k=vegetable+garden+starter+kit&tag=${AMAZON_TAG}&ascsubtag=yield-estimator`}
            target="_blank"
          ...
          >
            ...
            <div className="p-5">
              ...
              <h3 className="text-base font-semibold text-[var(--color-text)] group-hover:text-[var(--color-primary)]">Vegetable Garden Starter Kits</h3>
              <p className="mt-1 text-sm text-[var(--color-text-muted)]">Complete seed starter kits with trays, soil, and popular vegetable seeds. Everything you need to start growing your own food at home.</p>
              <div className="mt-3 flex items-center justify-between">
                <span className="text-sm font-bold text-[var(--color-text)]">$15 - $45</span>
                <span className="text-sm font-medium text-[var(--color-primary)] group-hover:underline">View on Amazon &rarr;</span>
              </div>
            </div>
          </a>
          <a
            href={`https://www.amazon.com/s?k=garden+harvest+basket+bag&tag=${AMAZON_TAG}&ascsubtag=yield-estimator`}
            target="_blank"
            rel="noopener noreferrer nofollow sponsored"
            className="group block overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] transition-all hover:border-[var(--color-primary)]/30 hover:shadow-md"
          >
            ...
            <div className="p-5">
              ...
              <h3 className="text-base font-semibold text-[var(--color-text)] group-hover:text-[var(--color-primary)]">Garden Harvest Baskets</h3>
              <p className="mt-1 text-sm text-[var(--color-text-muted)]">Durable harvest baskets and garden hods for collecting your produce. Rinse vegetables right in the basket with mesh or slatted designs.</p>
              <div className="mt-3 flex items-center justify-between">
